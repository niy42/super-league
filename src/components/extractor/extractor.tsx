    ...
    <>
      <nav className="relative mx-auto flex w-full max-w-7xl items-start justify-between gap-4 px-4 py-4 sm:flex-row sm:items-center sm:gap-0 sm:px-12 sm:py-6">
        ...
        <div className="relative flex sm:hidden">
          ...
          {toggleMenu && (
            <ul
              className={`mobile-menu white-glassmorphism fixed top-0 right-0 z-20 flex h-screen w-[70vw] list-none flex-col items-end justify-start rounded-l-md bg-linear-to-br from-white/20 to-white/5 p-9 text-white shadow-2xl ${closing ? "slide-out" : ""}`}
            >
